...
export default function Dashboard() {
  ...
  const [activeTab, setActiveTab] = useState<'ceo' | 'cfo' | 'cto' | 'cmo'>('ceo');
  ...
  return (
    <div className="space-y-8 animate-fade-in pb-12">
      ...
      {/* Tabs list with modern Pill-glassmorphism */}
      <div className="flex flex-wrap gap-2 p-1 bg-gray-100/80 dark:bg-gray-800/40 backdrop-blur-md rounded-xl max-w-2xl border border-gray-200/40 dark:border-gray-700/30">
        {[
          { id: 'ceo', name: 'CEO Command', icon: Building2, activeClass: 'bg-white text-primary-700 shadow-sm dark:bg-gray-900 dark:text-primary-400 border border-gray-200/50 dark:border-gray-800' },
          { id: 'cfo', name: 'CFO Finance', icon: DollarSign, activeClass: 'bg-white text-emerald-700 shadow-sm dark:bg-gray-900 dark:text-emerald-400 border border-gray-200/50 dark:border-gray-800' },
          { id: 'cto', name: 'CTO Technology', icon: Shield, activeClass: 'bg-white text-indigo-700 shadow-sm dark:bg-gray-900 dark:text-indigo-400 border border-gray-200/50 dark:border-gray-800' },
          { id: 'cmo', name: 'CMO Marketing', icon: TrendingUp, activeClass: 'bg-white text-purple-700 shadow-sm dark:bg-gray-900 dark:text-purple-400 border border-gray-200/50 dark:border-gray-800' }
        ].map(tab => {
          const Icon = tab.icon;
          ...
          return (
            <button
              ...
              className={cn(
                'flex items-center gap-2 px-4 py-2.5 text-xs sm:text-sm font-bold rounded-lg transition-all',
                isActive 
                  ? tab.activeClass 
